...
export const INITIAL_TRACKING_STREAMS: StreamApplication[] = [
  ...
  },
  {
    ...
    statusType: 'in_progress',
    steps: [
      { id: '1', title: 'Application Dossier Generated', status: 'completed', date: 'Today, 09:00 AM', note: 'Ready for submission via CareNav One-App' },
...
export const PRESET_TRACKING_STREAMS: Record<string, StreamApplication[]> = {
  ...
  cardiac_delhi: [
    ...
    },
    {
      ...
      statusType: 'in_progress',
      steps: [
        { id: '1', title: 'RAN Application Form Filled', status: 'completed', date: '13 Sep', note: 'Prepared via CareNav One-App' },
